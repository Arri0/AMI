...
<div class="contents">
	...
	<PresetProp
		...
		presetMap={instance.preset_map}
		on:change={(e) => changeBankAndPreset(e.detail.bank, e.detail.preset)} />
	<BoolProp
		name={'Reverb'}
		value={instance.reverb.active}
		on:change={(e) => changeReverbActive(e.detail)} />
	<NumProp
		...
		defaultValue={0.2}
		numDecimalPlaces={2}
		on:change={(e) => changeReverbParams()} />
	<NumProp
		name={'Reverb Damping'}
